          ...
          <ol>
            ...
            <li>
              ...
              <ol class="chinese-list-latin">
                ...
                <li><a v-anchor="'#license'">开源协议</a></li>
                <li><a v-anchor="'#references'">参考资料</a></li>
              </ol>
            </li>
          </ol>
        </details>
...
&lt;/div&gt;</code></pre>
      ...
      <h3 id="license">
        开源协议<a v-anchor="'#license'" class="anchor">#</a>
      </h3>
      <p>本项目遵循MIT协议开源。</p>

      <h3 id="references">
        参考资料<a v-anchor="'#references'" class="anchor">#</a>
      </h3>
